    ...
    <body>
      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
        ...
        <?php
                ...
                $updateMajor = "UPDATE quantify.major SET ";
                
                if(strcmp($MajorName,'')!=0) {
                    $updateMajor .= "MajorName = '$MajorName'";
                }
                
                if(strcmp($MajorName,'')!=0 && strcmp($DegreeType,'')!=0) {
                    $updateMajor .= ",DegreeType = '$DegreeType'";
                } else if(strcmp($lname,'')!=0) {
                    $updateMajor .= "DegreeType = '$DegreeType'";
                }
                
                if((strcmp($MajorName,'')!=0 || strcmp($DegreeType,'')!=0) && strcmp($CreditRequired,'')!=0) {
                    $updateMajor .= ",CreditRequired = '$CreditRequired'";
                } else if(strcmp($street,'')!=0) {
                    $updateMajor .= "CreditRequired = '$CreditRequired'";
                }
                
                $updateMajor .= " WHERE MajorID = '$MajorID'";
                
                if(mysqli_query($con, $updateMajor)){
                    echo "<p>$MajorID updated successfully.";
                } else{
