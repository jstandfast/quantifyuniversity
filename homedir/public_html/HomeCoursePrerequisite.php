...
<div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
            <div class="w3-row-padding w3-margin-top w3-margin-top" style = "color:white; overflow-x: hidden"> 
                ...
                <a class="w3-quarter" style="text-decoration: none;" href="Courses.php">
                  <div class="w3-center ">
      ...
      <div style="height:900px; width: auto; ;">
        ...
        <thead>
            <tr>
                    ...
                    <th style="width:25%;">Prerequisite ID</th>
                    <th style="width:25%;">Minium Grade</th>
     ...
     <?php
            ...
            $conn = mysqli_connect($host, $user, $password, $dbname, $port, $socket);
                 if (mysqli_connect_errno()) {
                    ...
                    $sql = "SELECT prerequisite.CourseID, prerequisite.PrereqID,prerequisite.MinGrade, course.CourseName FROM  prerequisite NATURAL JOIN course
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><a '?id=".$row["CourseID"]."'>
                        ".$row["CourseID"]. "</a></td><td>"
