          ...
          <div class="w3-center ">
            ...
            <div class="w3-container">
              <h3>View Advisors</h3>
                ...
                <?php $studentid=$_GET['StudentID']; print("<a class='w3-quarter' style='text-decoration: none;'' href='Facultystudentinfo.php?UserID=$studentid'>"); ?>
                  <div class="w3-center ">
                    <i class=" fa-5x" aria-hidden="true"></i>
                    <div class="w3-container">
        ...
        <div class="container text-center">
            ...
            <div class='content'>
                ...
                <?php 
                    ...
                    print("<p>Degree audit for $studentname ($studentid)</p>");
                    
                    studentDegreeAudit($con,$studentid);
