      ...
      <div style="height:900px; width: auto; ;">
        ...
        <thead>
            <tr>
                    ...
                    <th style="width:10%;">MajorID</th>
                    <th style="width:10%;">Degree Type</th>
...
?>
    ...
    $conn = mysqli_connect($host, $user, $password, $dbname, $port, $socket);
            ...
            $sql = "SELECT DISTINCT major.MajorID, major.DeptID, major.MajorName, major.CreditRequired,major.DegreeType,department.deptName   
            ...
            if ($result->num_rows > 0) {
               while($row = $result->fetch_assoc()) {
                    echo "<tr><td><a href='?id=".$row["MajorID"]."'>
