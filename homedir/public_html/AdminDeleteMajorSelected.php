...
<html>
    ...
    <body>
      <section class="header">  
        ...
        echo "<div class='w3-panel w3-black w3-center'><h2>Major has been deleted!</h2></div>";
        } else if(mysqli_errno($conn) == 1451) {
            echo "<br><h3 class='w3-center w3-red'>ERROR: You cannot delete a Major with active courses or department members!!</h3>";
        } else {
