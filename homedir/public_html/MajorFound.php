   ...
   <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
            <div class="w3-row-padding w3-margin-top w3-margin-top" style = "color:white; overflow-x: hidden"> 
                ...
                <a class="w3-quarter" style="text-decoration: none;" href="viewMajors.php">
                  <div class="w3-center ">
        ...
        <thead>
            <tr>
             ...
             <?php
                ...
                $query="SELECT MajorName, DegreeType,CreditRequired
                FROM major WHERE $searchtype LIKE '$search'";
