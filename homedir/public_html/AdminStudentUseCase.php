...
<a class="w3-quarter" style="text-decoration: none;" href="AdminHomePage.php">
          ...
          <a class="w3-quarter" style="text-decoration: none;" href="AdminStudentSchdeule.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
     ...
     <a class="w3-quarter" style="text-decoration: none;" href="AdminStudentRegister.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
          ...
          <a class="w3-quarter" style="text-decoration: none;" href="AdminStudentAdvisor.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
              <h3>View Student Advisor</h3>
            </div>
          </div>
        </a>  
         <a class="w3-quarter" style="text-decoration: none;" href="AdminStudentDegreeAudit.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
