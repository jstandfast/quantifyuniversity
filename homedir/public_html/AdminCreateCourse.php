...
<a class="w3-quarter" style="text-decoration: none;" href="AdminCourseOption.php">
        ...
        <div class="w3-panel w3-center" >
            <form class="w3-container" action = "AdminCourseAddedSubmit.php" method = "post">
...
<!--            <input class="w3-input" type="number" name="dept">-->
            ...
            <input class="w3-input" type="text" name="CourseName" required>
            <br>
            <label class="w3-label w3-white"><b>Course ID</b></label>
            <input class="w3-input" type="text" name="CourseID">
            <br>
            <label class="w3-label w3-white"><b>Course Credit</b></label>
            <input class="w3-input" type="number" max="4" min="2" name="Credits" required>
            <br>
            <label class="w3-label w3-white"><b>Level</b></label>
            <input class="w3-input" type="text" name="Level"></input>
            <br>
            <label class="w3-label w3-white"><b>Course Type</b></label>
            <input class="w3-input" type="text" name="CourseType"></input>
            <br>
...
function getAllMajors(){
    ...
    if(mysqli_num_rows($result) > 0){
        echo "<option disabled selected value> -- Select A Major -- </option>";
