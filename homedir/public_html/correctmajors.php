    ...
    <body>
      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
            <div class="w3-row-padding w3-margin-top w3-margin-top" style = "color:white; overflow-x: hidden"> 
                ...
                <a class="w3-quarter" style="text-decoration: none;" href
                ="SearchStudent.php">
                  <div class="w3-center ">
                    <i class=" fa-5x" aria-hidden="true"></i>
                    <div class="w3-container">
            ...
            <div class = "container text-center">
                <h2>Correct Major Requirements</h2>
                ...
                <div class="content">
                    <?php 
                        ...
                        $majorsarray=getMajors($con);
                        
                        echo "<form action='' method='post'>
                                <select id='major' name='major'>
                                    <option value='' selected disabled hidden>Select Major</option>";
                        
                        for($i=0;$i<count($majorsarray);$i++) {
                            
                            $majordata=getMajorData($con,$majorsarray[$i]);
                            
                            $majorid=$majordata['MajorID'];
                            $majorname=$majordata['MajorName'];
                            
                            echo "<option value='$majorid'>$majorname</option>";
                        }
                        
                        echo "</select><p><input type='submit' name='submit' value='Submit'><input type='reset' name='reset' value='Reset'></form></p>";
        	            ...
        	            if($submitted) {
        	                ...
        	                if(!empty($_POST['major'])) {
        	                    ...
        	                    correctMajorRequirements($con,$majorid);
        	                    
        	                    echo "<p>Check if it worked for $majorid.</p>";
