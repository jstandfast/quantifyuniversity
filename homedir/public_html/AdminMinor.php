...
<a class="w3-quarter" style="text-decoration: none;" href="AdminHomePage.php">
          ...
          <a class="w3-quarter" style="text-decoration: none;" href="AdminAddMinor.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
     ...
     <a class="w3-quarter" style="text-decoration: none;" href="AdminEditMinor.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
          ...
          <a class="w3-quarter" style="text-decoration: none;" href="AdminDeleteMinor.php">
          <div class="w3-center ">
            <!--<img src="img/file_icon.png"  alt="icon">-->
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
      ...
      <div style="height:900px; width: auto; ;">
        ...
        <thead>
            <tr>
                    ...
                    <th style="width:30%;">Minor Name</th>
                    <th style="width:30%;">Minor ID</th>
