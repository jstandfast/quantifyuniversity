    ...
    <head>
        ...
        <script language='JavaScript'>
            function toggle(source) {
              checkboxes = document.getElementsByName('holdid[]');
      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
        ...
        <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
            <div class="w3-row-padding w3-margin-top w3-margin-top" style = "color:white; overflow-x: hidden"> 
                ...
                <a class="w3-quarter" style="text-decoration: none;" href="AdminAddHold.php">
                  <div class="w3-center ">
                    <i class=" fa-5x" aria-hidden="true"></i>
                    <div class="w3-container">
                      <h3>Add a Hold</h3>
        ...
        <div class = "container text-center">
    		...
    		<?php
    		    ...
    		    for ($counter=0;$row=mysqli_fetch_row($result);++$counter)
    		    {
    		        ...
    		        print("<td><input type='checkbox' name='holdid[]' value='$holdidx'></td>");
                ...
                print("
		            <input type='submit' name='submit' value='Delete Selected Hold(s)'>
		        </form><br>");
    		    ...
    		    if($_SERVER['REQUEST_METHOD'] == 'POST') {
    		        ...
    		        if(isset($_POST['submit'])) {
        		        ...
        		        $idarray=$_POST['holdid'];
        		            
        		        $holdtestid;
        		        
        		        $totalchecked = count($idarray);
        		        
        		        echo "<p>$totalchecked Holds Selected.";
        		        
        		        for($j=0;$j<$totalchecked;$j++) {
        		            
        		            $holdtestid=$idarray[$j];

                            $query1 = "SELECT HoldID FROM hold";
        		        
        		            $result1 = mysqli_query($con,$query1) or die(mysql_error());
        		            
            		        for($counter=0;$row=mysqli_fetch_row($result1);++$counter) {
            		            
            		            $holdtoremoveid=$row[0];
            		            
            		            if(!strcmp($holdtoremoveid,$holdtestid)) {
            		                
            		                $query2 = "SELECT HoldID FROM student_hold WHERE HoldID = '$holdtoremoveid';";
            		                ...
            		                if($count2==0) {
                        			    $query3 = "DELETE FROM hold WHERE (HoldID = '$holdtoremoveid');";
                        			    $result3 = mysqli_query($con,$query3) or die(mysql_error());
                        			    echo "<p>$holdtoremoveid removed. <a href=".">Refresh page</a> to see updated list.";
                        		    } else {
                        		        echo "<p>Could not remove $holdtoremoveid. Time Slot is in use.<br>";
                        		    }
            		            }
            		        }
        		        }
