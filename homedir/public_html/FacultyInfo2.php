        ...
        <?php 
            ...
            <table class="table table-striped table-dark">
                <tbody>
                    ...
                    <tr>
                        <td><?php print("<a href='editfaculty.php?UserID=$userid&Rank=1' class='clean'></a>"); ?></td>
                        <td>Rank: </td>
                        <td><?php print("$rank"); ?></td>
                    </tr>
                    <tr>
                        <td><?php print("<a href='editfaculty.php?UserID=$userid&Dept=1' class='clean'></a>"); ?></td>
                        <td>Department(s): </td>
                        <td><?php print("<p>$dept</p><p>$dept2</p><p>$dept3</p>"); ?></td>
                    </tr>
                    <tr>
                        <td><?php print("<a href='editfaculty.php?UserID=$userid&Advisees=1' class='clean'></a>"); ?></td>
                        <td>Advisees: </td>
                    ...
                    <tr>
                        <td><?php print("<a href='editfaculty.php?UserID=$userid&Sched=1' class='clean'></a>"); ?></td>
