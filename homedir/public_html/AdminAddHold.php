      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
        ...
        <div class = "container text-center">
            ...
            <?php
    		    ...
    		    $query = "SELECT HoldID FROM hold ORDER BY HoldID DESC LIMIT 1";
    	        ...
    	        $idnumber = intval($splitlastid[2]) + 1;
    	        
    	        $holdid = "HOLD" . $idnumber;
    	        
                print("<div class='smalldiv'>
                        <form action='' method='post'>
                            <p>New Hold ID: $holdid

                            <p><label for='holdtype'>Hold Type:</label>
                                <input name='holdtype' type='text'>
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if(isset($_POST['holdtype'])) {
                            ...
                            $query="INSERT INTO hold (HoldID,HoldType) VALUES ('$holdid','$holdtype');";
                            
                            if ($con->query($query) === TRUE) {
                                echo "<p>$holdid added to holds.";
                            } else {
                                echo "<p>Error: " . $sql . "<br>" . $con->error;
                            }
                            
                        } else {
                            echo "<p>Must enter a hold type.";
                        }
