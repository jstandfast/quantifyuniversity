...
<a class="w3-quarter" style="text-decoration: none;" href="AdminHomePage.php">
     ...
     <a class="w3-quarter" style="text-decoration: none;" href="AdminEditDepartments.php">
        ...
        <?php
          ...
          $query="SELECT DeptID,DeptName,BuildingID,OfficeID,DeptPhone,DeptEmail,ChairmanID,SecretaryID
                    from department";
          ...
          if(!($result=mysqli_query($con,$query))) {
            ...
            for ($counter=0;$row=mysqli_fetch_row($result);++$counter)
            {
              ...
              print("<tr><td class = 'clean'><a class = 'clean' href = 'AdminDeleteDepartmentSelected.php?MajorID=$row[0]'>Select</a></td>");
