      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
        ...
        <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
            <div class="w3-row-padding w3-margin-top w3-margin-top" style = "color:white; overflow-x: hidden"> 
                ...
                <?php print("<a class='w3-quarter' style='text-decoration: none;' href='EditUser.php?UserID=$userid'>"); ?>
                  <div class="w3-center ">
                    <i class=" fa-5x" aria-hidden="true"></i>
                    <div class="w3-container">
                      <h3>Edit User</h3>
                ...
                <?php print("<a class='w3-quarter' style='text-decoration: none;' href='RemoveUser.php?UserID=$userid'>"); ?>
                  <div class="w3-center ">
                    <i class=" fa-5x" aria-hidden="true"></i>
                    <div class="w3-container">
                      <h3>Remove User</h3>
