...
<main>
  <div class="container-fluid">
    <div class="row">
        ...
        <h1 style="text-align:center">Add New Minor</h1>
        <div class="w3-panel w3-center" >
            <form class="w3-container" action = "AdminMinorAddedSubmit.php" method = "post">
...
<!--            <input class="w3-input" type="number" name="dept">-->
            ...
            <label class="w3-label w3-white"><b>Minor ID</b></label>
            <input class="w3-input" type="text" name="MinorID">
            <br>
            <label class="w3-label w3-white"><b>Minor Name</b></label>
            <input class="w3-input" type="text" name="MinorName">
            <br>
               <label class="w3-label w3-white"><b>Credits Required</b></label>
            <input class="w3-input" type="text" name="CreditsRequired">
            <br>

            <div>
                <button class="w3-btn w3-black" type="submit" onclick="validateEmptyFields();">Create Minor</button>
            </div>
            </form>
        </div>
    </div>
