      ...
      <div class = "w3-container w3-card-4 w3-black w3-opacity-min" style="max-width: auto">
		...
		<?php
            ...
            print("<div class='content'>
                <p><a href='ViewUsers.php' ><img src='images/BackToUsers.png' style='width:200px;height:200px;'></a><a href='SearchUser.php' ><img src='images/NewUserSearch.png' style='width:200px;height:200px;'></a></p>");
			...
			print("<form action='userremoved.php' method='post'>
        			<p>Are you sure you want remove user $userid?<input type='hidden' name='userid' value='$userid'>
