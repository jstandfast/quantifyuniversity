...
<a class="w3-quarter" style="text-decoration: none;" href="AdminViewDepartments.php">
        ...
        <div class="w3-panel w3-center" >
             <form class="w3-container" action = "AdminDepartmentAddedSubmit.php" method = "post">
            <label class="w3-label w3-white"><b>Department Name</b></label>
            <input class="w3-input" type="text" name="DeptName" required>
            <br>
            <label class="w3-label w3-white"><b>Department ID</b></label>
            <input class="w3-input" type="text" name="DeptID">
            <br>
            <label class="w3-label w3-white"><b>Department Phone</b></label>
            <input class="w3-input" type="text" name="DeptPhone" required>
            <br>
            <label class="w3-label w3-white"><b>Department Email</b></label>
            <input class="w3-input" type="text" name="DeptEmail"></input>
            <br>
            <label class="w3-label w3-white"><b>Department Room</b></label>
            <select class="w3-select w3-border" name="OfficeID" required>
                <?php getAllRooms(); ?>
            </select><br><br>
            <label class="w3-label w3-white"><b>Department Building</b></label>
            <select class="w3-select w3-border" name="BuildingID" required>
                <?php getAllBuildings(); ?>
            </select><br><br>
            <label class="w3-label w3-white"><b>Department Chair</b></label>
            <select class="w3-select w3-border" name="ChairmanID">
            <?php getAllFacultyNotMemb(); ?>
             </select>
            <br><br>
            <label class="w3-label w3-white"><b>Department Secretary</b></label>
            <select class="w3-select w3-border" name="SecretaryID">
            <?php getAllFacultyNotMemb(); ?>
             </select>
            <br><br>

            <div>
                <button class="w3-btn w3-black" type="submit" onclick="validateEmptyFields();">Create Course</button>
            </div>
            </form>
        </div>
    </div>
