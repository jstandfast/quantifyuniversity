...
<a class="w3-quarter" style="text-decoration: none;" href="FacultyInfo.php">
  ...
  <div class = "container text-center">
                ...
                $query="SELECT DISTINCT user.UserID, user.FirstName, user.LastName, student.StudentType FROM student JOIN user WHERE user.UserID = student.StudentID AND $searchtype LIKE '$search';";
			    ...
			    if($count==0) {
        		    ...
        		    for ($counter=0;$row=mysqli_fetch_row($result);++$counter)
        		    {
        		    	...
        		    	print("<tr><td class = 'clean'><a class = 'clean' href = 'Facultystudentinfo.php?UserID=$row[0]'>Select</a></td>");
