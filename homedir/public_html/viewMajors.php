...
<body>
 ...
 <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/cosmo/bootstrap.min.css" integrity="sha384-5QFXyVb+lrCzdN228VS3HmzpiE7ZVwLQtkt+0d9W43LQMzz4HBnnqvVxKg6O+04d" crossorigin="anonymous">
     <div class = "container text-center">
                <h1>Click on Major to view courses</h1></div></div>
...
<br>
      <div style="height:900px; width: auto; ;">
        ...
        <thead>
            <tr>
                    ...
                    <th style="width:25%;">MajorID</th>
                    <th style="width:25%;">Degree Type</th>
                    <th style="width:25%;">Credits</th>
                </tr>

            <div class='content'>
            <form action="MajorFound.php" method="post">
    ...
    $conn = mysqli_connect($host, $user, $password, $dbname, $port, $socket);
            ...
            $sql = "SELECT major.MajorID, major.MajorName, major.DegreeType, major.CreditRequired,department.DeptID 
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><a href='MajorCourse.php?id=".$row["DeptID"]."'>
                        ".$row["MajorName"]. "</a></td><td>"
                        .$row["MajorID"]. "</td><td>"  
                        .$row["DegreeType"]. "</td><td>" 
                        .$row["CreditRequired"]. "</td><td>" ;
