...
header('Refresh: 3; url = AdminCreateCourse.php');
session_start();
...
<a class="w3-quarter" style="text-decoration: none;" href="AdminCourseOption.php">
    ...
    <?php
     ...
     $host="quantify.cy8rwonvm5qr.us-east-1.rds.amazonaws.com";
        ...
        //load page here
       $sql  = "INSERT INTO course (CourseID, CourseName, Credits, Level, CourseType,DeptID) VALUES ('".$_POST['CourseID']."', '".$_POST['CourseName']."'
        ,'".$_POST['Credits']."','".$_POST['Level']."','".$_POST['CourseType']."','".$_POST['DeptID']."')";
