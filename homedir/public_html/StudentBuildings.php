...
<body>
  <section class="header">  
    ...
    <a href="Prerequisite.php">prerequisite</a> 
...
<br>
      <div style="height:900px; width: auto; ;">
        ...
        <thead>
            <tr>
                    ...
                    <th style="width:33%;">BuildingID</th>
                    <th style="width:33%;">BuildingID</th>
                    <th style="width:33%;">Building Name</th>
                </tr>
    ...
    $conn = mysqli_connect($host, $user, $password, $dbname, $port, $socket);
            ...
            $sql = "SELECT BuildingID, BuildingName,BuildingUse
             FROM building ";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><a href='?id=".$row["BuildingID"]."'>
                    ".$row["BuildingID"]. "</a></td><td>"
                        .$row["BuildingName"]. "</td><td>"  
                        .$row["BuildingUse"]. "</td><td>" 
;
                }
            } else {
                $conn->close();
